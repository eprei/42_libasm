...
void compare_files(int *fd_file_write, int *fd_file_ft_write) {
  ...
  read(*fd_file_write, bufs_read[0], 10000);
  read(*fd_file_ft_write, bufs_read[1], 10000);
...
void test_ft_write(void) {
  ...
  test_write_and_compare_files(&fd_file_write, &fd_file_ft_write, "long_string in file", long_string,10000);
  ...
  reset_test(&fd_file_write, &fd_file_ft_write);
  printf("write fd_invalid:\treturn value:\t%zd\t\t", write(-1, long_string, 10000));
  print_errno();
  printf("ft_write fd_invalid:\treturn value:\t%zd\t\t", ft_write(-1, long_string, 10000));
  print_errno();
  compare_files(&fd_file_write, &fd_file_ft_write);
